...
public class ViewCommunity extends javax.swing.JPanel {
    ...
    public ViewCommunity(CommunityHistory communityhistory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        communityTbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "AdminID", "Community Name", "Community ID"
            }
        ) {
        ...
        jLabel2.setText("CommName");

        jLabel3.setText("CommID");
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(commID, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if (i >= 0) {
            ...
            model.setValueAt(commID.getText(), i, 2);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) communityTbl.getModel();
        Community selectedPatient = (Community) model.getValueAt(selectedRowIndex, 0);
        communityhistory.deleteCommunity(selectedPatient);
 ...
 private void populateTable() {
        DefaultTableModel model = (DefaultTableModel) communityTbl.getModel();
        model.setRowCount(0);
        for (Community ps : communityhistory.getCommunityhistory()) {
            System.out.println(ps.getAdminId());
            System.out.println(ps.getCommunityAdminName());
            System.out.println(ps.getCommunityID());

            Object[] row = new Object[3];
            row[0] = ps;
            row[1] = ps.getCommunityAdminName();
            row[2] = ps.getCommunityID();
            model.addRow(row);
        }
    }
}
